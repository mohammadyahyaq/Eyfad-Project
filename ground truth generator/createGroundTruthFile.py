...
images=[]
groundtruth=[]
path1='train' #need to have folder call train
path2='metaData_train' #need to have folder call metaData_train

path3='test' #need to have folder call test
path4='metaData_test' #need to have folder call metaData_test
...
def ground_truth_files(path1,path2):
...
ground_truth_files(path1,path2)
ground_truth_files(path3,path4)